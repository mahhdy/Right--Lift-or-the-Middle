...
\tikzset{
  thickarrow/.style={-{Stealth[length=8pt,width=6pt]}, line width=2pt},
  thinarrow/.style={-{Stealth[length=5pt,width=4pt]}, line width=1pt},
  dashedarrow/.style={-{Stealth[length=5pt,width=4pt]}, line width=1pt, dashed}
}
...
\titleformat{\section}
    ...
    [\vspace{2pt}%
     \noindent{\color{RightBlue!40}\rule{\linewidth}{0.5pt}}%
     \vspace{1pt}]
...
% ══════════════════════════════════════════════════════════════════════════════
%                   📋 تنظیمات فهرست مطالب (بعد از xepersian)
% ══════════════════════════════════════════════════════════════════════════════
