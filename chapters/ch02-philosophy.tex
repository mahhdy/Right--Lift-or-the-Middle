...
\begin{figure}[t!]
	...
	\begin{tikzpicture}[scale=0.8]
		...
		\node[text=RightBlue, font=\small] at (0, 4) {\fa{تکرار}};
		...
		% ─────────── روایت مارکس ───────────
		\node[text=LeftRedDark, font=\bfseries] at (0, 2) {\fa{ماتریالیسم تاریخی مارکس}};
...
\begin{figure}[t!]
	...
	\begin{tikzpicture}[scale=0.8]
		...
		% عنوان
		\node[font=\large\bfseries, text=DarkGray] at (0, 4.5) {\fa{رالز در برابر نوزیک}};
...
\begin{figure}[t!]
	...
	\begin{tikzpicture}[scale=0.95]
		...
		% عنوان
		\node[font=\large\bfseries, text=DarkGray] at (0, 5.8) {\fa{دو مفهوم آزادی}};
		...
		\node[text=DarkGray, font=\small, text width=5.5cm, align=center] at (-3.75, 2.5) {
			\\[2pt]
			\fa{آزادی از مداخله}\\[2pt]
			\fa{«رهایم بگذارید»}\\[2pt]
			\fa{حوزه خصوصی}\\[2pt]
		...
		\node[text=DarkGray, font=\small, text width=5.5cm, align=center] at (3.75, 2.5) {
			\\[2pt]
			\fa{آزادی برای خودآیینی}\\[2pt]
			\fa{«خودم را محقق کنم»}\\[2pt]
			\fa{خودفرمانی جمعی}\\[2pt]
			\fa{توانمندسازی}
		};
...
\begin{figure}[t!]
	\centering
	\begin{tikzpicture}[scale=0.95, xscale=1, yscale=0.85]
		
		% عنوان
		\node[font=\large\bfseries, text=DarkGray] at (0, 5.5) {\fa{تنوع درونی چپ و راست در فلسفه سیاسی}};
		
		% ─────────── چپ ───────────
		\fill[LeftRed, opacity=0.15, rounded corners=8pt] (-7.5, 0) rectangle (-0.5, 4.5);
		\draw[line width=2pt, color=LeftRed, rounded corners=8pt] (-7.5, 0) rectangle (-0.5, 4.5);
		\node[text=LeftRed, font=\bfseries\large] at (-4, 3.6) {\fa{چپ}};
		
		% زیرمجموعه‌های چپ
		\fill[LeftRedLight, opacity=0.5, rounded corners=5pt] (-7.2, 0.8) rectangle (-4.2, 3);
		\node[text=LeftRedDark, font=\small\bfseries] at (-5.7, 2.5) {\fa{آزادی‌خواه}};
		\node[text=DarkGray, font=\scriptsize, text width=2.5cm, align=center] at (-5.7, 1.5) {
			\fa{آنارشیست}\\
			\fa{چپ نو}
		};
		
		\fill[LeftRedDark, opacity=0.4, rounded corners=5pt] (-4, 0.8) rectangle (-0.8, 3);
		\node[text=white, font=\small\bfseries] at (-2.4, 2.5) {\fa{دولت‌گرا}};
		\node[text=VeryLightGray, font=\scriptsize, text width=2.5cm, align=center] at (-2.4, 1.5) {
			\fa{لنینیست}\\
			\fa{سوسیال‌دموکرات}
		};
		% نقطه اختلاف چپ
		\node[text=OrangeAccent, font=\small] at (-4, 0.5) {\fa{اختلاف: نقش دولت}};
		
		% ─────────── راست ───────────
		\fill[RightBlue, opacity=0.15, rounded corners=8pt] (0.5, 0) rectangle (7.5, 4.5);
		\draw[line width=2pt, color=RightBlue, rounded corners=8pt] (0.5, 0) rectangle (7.5, 4.5);
		\node[text=RightBlue, font=\bfseries\large] at (4, 3.6) {\fa{راست}};
		
		% زیرمجموعه‌های راست
		\fill[RightBlueLight, opacity=0.5, rounded corners=5pt] (0.8, 0.8) rectangle (3.8, 3);
		\node[text=RightBlueDark, font=\small\bfseries] at (2.3, 2.5) {\fa{محافظه‌کار}};
		\node[text=DarkGray, font=\scriptsize, text width=2.5cm, align=center] at (2.3, 1.5) {
			\fa{سنت‌گرا}\\
			\fa{برکی}
		};
		
		\fill[CenterGreen, opacity=0.5, rounded corners=5pt] (4, 0.8) rectangle (7.2, 3);
		\node[text=white, font=\small\bfseries] at (5.6, 2.5) {\fa{لیبرتارین}};
		\node[text=VeryLightGray, font=\scriptsize, text width=2.5cm, align=center] at (5.6, 1.5) {
			\fa{هایک}\\
			\fa{نوزیک}
		};
		% نقطه اختلاف راست
		\node[text=OrangeAccent, font=\small] at (4, 0.5) {\fa{اختلاف: سنت یا بازار؟}};
