...
% عنوان
\node[font=\large\bfseries, text=DarkGray] at (0, 8) {\fa{مقایسه: لنینیسم و مائوئیسم}};

% کادر لنینیسم
\fill[LeftRed, opacity=0.15, rounded corners=10pt] (-7, 0.5) rectangle (-0.5, 7);
\draw[line width=2pt, color=LeftRed, rounded corners=10pt] (-7, 0.5) rectangle (-0.5, 7);

\node[text=LeftRed, font=\bfseries\large] at (-3.75, 7.5) {\fa{لنینیسم}};
...
% کادر مائوئیسم
\fill[OrangeAccent, opacity=0.15, rounded corners=10pt] (0.5, 0.5) rectangle (7, 7);
\draw[line width=2pt, color=OrangeAccent, rounded corners=10pt] (0.5, 0.5) rectangle (7, 7);

\node[text=OrangeAccent, font=\bfseries\large] at (3.75, 7.5) {\fa{مائوئیسم}};
