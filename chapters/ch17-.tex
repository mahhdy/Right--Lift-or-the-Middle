...
\begin{tcolorbox}[
    ...
    colframe=DarkGray, % FIXED: use defined color name
    boxrule=2pt,
    arc=8pt,
    fonttitle=\bfseries\large,
    title={\rl{نقل\'قول آغازین}},
    attach boxed title to top center={yshift=-3mm},
    boxed title style={colback=DarkGray, colframe=DarkGray} % FIXED: use defined color name
]
\begin{center}
...
\begin{tcolorbox}[
    enhanced,
    colback=LeftRed!8, % FIXED: use defined color name
    colframe=LeftRed, % FIXED: use defined color name
    boxrule=1.5pt,
    arc=5pt,
    fonttitle=\bfseries,
    title={\rl{(!) مناظره: پایان چپ و راست؟}} % FIXED: replaced emoji with text indicator
]
\begin{multicols}{2}
